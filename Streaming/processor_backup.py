...
from Pyprojects.Streaming.config_bkd import KAFKA_BOOTSTRAP_SERVERS, KAFKA_TOPIC, CHECKPOINT_DIR, PROCESSING_TIME
...
class DebeziumKafkaProcessor:
    ...
    def write_to_console(self, final_df):
        try:
            ...
            print("Error starting write stream to console:")
            traceback.print_exc()
            raise
